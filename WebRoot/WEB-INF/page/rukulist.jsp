...
$(document).ready(function(){
  ...
  <body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><a href="${pageContext.request.contextPath }/page/ruku_forward.action"><span><img src="${pageContext.request.contextPath}/images/t01.png"/></span>添加</a></li>
