...
<body>
    ...
    <table class="tablelist">
        ...
        <tbody>
        <s:iterator value="#request['gysList']" id="gysList">
        <tr>
        <td><input name="" type="checkbox" value="" /></td>
        <td><s:property value="#gysList.id"/></td>
        <td><s:property value="#gysList.gysName"/></td>
        <td><s:property value="#gysList.gysAddress"/></td>
        <td><s:property value="#gysList.gysPhone"/></td>
        <td><s:property value="#gysList.gysMail"/></td>
        <td><a href="${pageContext.request.contextPath }/page/gys_edit.action?id=<s:property value="#gysList.id"/>" class="click" id="">编辑</a>     <a href="${pageContext.request.contextPath }/page/gys_delete.action?id=<s:property value="gysList.id"/>" class="tablelink"> 删除</a></td>
        </tr> 
          </s:iterator>      
        </tbody>
    </table>
